"""
Django settings for fancy_smoke_dev_113941 project.
...
ROOT_URLCONF = 'fancy_smoke_dev_113941.urls'
...
WSGI_APPLICATION = 'fancy_smoke_dev_113941.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_smoke_dev_113941 API",
    "DESCRIPTION": "API documentation for fancy_smoke_dev_113941 App",
    "VERSION": "v1",
}
